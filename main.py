...
config = load_config()
bot = telebot.TeleBot(config['7494334299:AAEdfif9zAsFvppjUWB_jMNNS3GWx_jdR8E'])
ADMIN_IDS = set(config['5708896577'])
USER_FILE = config['main.py']
LOG_FILE = config['log_file']
COOLDOWN_TIME = config['300']
